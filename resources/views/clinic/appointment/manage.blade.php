                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($appointment->clinic_user_id != Null)
                                                                        ...
                                                                        {{$getassigndoctorinfo->name}} ({{$getassigndoctorinfo->specialities}})
                                                                    @else
                                                                    @endif
                                                                </td>
                                                            </tr>
                            ...
                            <div class="card widget-profile pat-widget-profile">
                                <div class="card-body">
                                        ...
                                        <div class="profile-info-widget">
                                            ...
                                            <div class="profile-det-info">
                                                ...
                                                <div class="patient-details">
                                                    ...
                                                    <h5><b>Employee No. : </b> <span id="model1-employeeID"></span> | <b>IC
                                                            No. :</b> <span id="model1-ICNumber"></span></h5>
                                                    <h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> <span
                                                            id="model1-patientAddress"></span></h5>
                                                    <h5><b>Race : </b> <span id="model1-patientRace"></span> | <b>Gender :
                                                        </b> <span id="model1-patientAge"></span></h5>
                                                    <h5><b>Conatct Number: </b> <span id="model1-patientContact"></span>
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="patient-info">
                                        <ul>
                                            <li>Company Coverage <span>RM <span id="model1-companyCoverage"></span> </span>
                                            </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('clinic.postAssignDoctor') }}" id="assignDr" method="POST">
                        ...
                        <button type="submit" class="d-flex justify-content-center align-items-center btn btn-primary w-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="patient-info">
                                        <ul>
                                            ...
                                            <li>Previous Checkup Date <span id="model-perviousCheckUpDate"> </span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                success: function (result) {
                    ...
                    $.each(dependents, function (index, dependent) {
                        ...
                        $patientList.append(
                            $('<option>', {
                                value: dependent.id,
                                text: label,
                                'data-benefit': dependent.min_benefit || '0.00'
                            })
                        );
                    });
                    ...
                    $patientList.off('change').on('change', function () {
                        ...
                        if (selectedVal === "employee") {
                            ...
                            let minBenefit = $("#patientlist option:selected").data("benefit") || '0.00';
