        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-lg-4 col-xl-3 theiaStickySidebar">
                    @include('employee.sidebar', ['activePage' => 'employeedashboard'])
                </div>
                <div class="col-md-7 col-lg-8 col-xl-9">
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-4 col-xl-6 patient-dashboard-top">
                            <div class="card">
                                <div class="card-body text-center">
                                    <h5>{{ $company->name }}</h5>
                                    <h6>Working Company</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4 col-xl-3 patient-dashboard-top">
                            <div class="card">
                                <div class="card-body text-center">
                                    <h5>{{ Auth()->user()->employee_id }}</h5>
                                    <h6>Employee ID</h6>
                                </div>
                            </div>
                        </div>
