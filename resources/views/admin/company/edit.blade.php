                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="bd-example bd-example-padded-bottom">
                                <a href="{{ route('admin.getManageCompany') }}" class="btn btn-dark btn-md">
                                    Back to Manage Company
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="modal-body">
                                <form method="POST" action="{{ route('admin.postEditCompany', $company->slug) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="logo" name="logo"
                                                    value="{{ $company->logo }}">
                                                @if ($company->logo)
                                                    <img src="{{ asset('site/uploads/company/' . $company->logo) }}"
                                                        alt="{{ $company->name }}" class="img-fluid" width="100">
                                                @endif
                                                @if ($errors->has('logo'))
                                                    <span class="text-danger" style="font-style: italic;">
                                                        <small
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="registration_number"
                                                    name="registration_number" value="{{ $company->registration_number }}"
                                                    required>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="commission"
                                                    name="commission" value="{{ $company->commission }}" required>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select id="status" class="form-control" name="status" required>
                                                    <option value="active" <?php if ($company->status == 'active') {
                                                        echo 'selected';
                                                    } ?>>Active</option>
                                                    <option value="hidden" <?php if ($company->status == 'hidden') {
                                                        echo 'selected';
                                                    } ?>>Hidden</option>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="contact_person_number"
                                                    ...
                                                    value="{{ $company->contact_person_number }}" required>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" id="description" rows="8" name="description" value="">{{ $company->description }}</textarea>
