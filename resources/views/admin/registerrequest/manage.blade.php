@extends('layouts.admin', ['activePage' => 'registrationrequest'])
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Clinic/ Company</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <!-- <li class="breadcrumb-item active"><a href="#">Dashboard</a></li> -->
                        <li class="breadcrumb-item active">Dashboard</li>
                        <li class="breadcrumb-item active">Register Request</li>
                                    ...
                                    @foreach ($lists as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ asset('site/uploads/bform/' . $item->bform) }}" target="_blank">B
                                                    Form</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-xs btn-outline-danger" href=""
                                                    onclick="if(!confirm(`Are you sure to delete {{ $item->name }} clinic!`)) { event.preventDefault(); }">Drop</a>
                                                &nbsp;
                                                <a class="btn btn-xs btn-outline-danger" href="" data-toggle="modal"
                                                    data-target="#adminclinic-{{ $item->id }}">Approve</a>
                                                &nbsp;
                                            </td>
                                        </tr>
                                        <div id="adminclinic-{{ $item->id }}" class="modal fade" tabindex="-1"
                                            role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="gridModalLabel">Approve
                                                            {{ $item->type }}</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        @if ($item->type == 'clinic')
                                                            <form method="POST"
                                                                action="{{ route('admin.postAddClinic') }}"
                                                                enctype="multipart/form-data">

                                                                @csrf
                                                                <input type="hidden" name="way" value="approved">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="number">Company Contact Number
                                                                                (*)</label>
                                                                            <input type="text" class="form-control"
                                                                                id="number" name="number"
                                                                                value="{{ $item->company_contact_number }}"
                                                                                required>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="contact_person_number">Contact
                                                                                Person Number (*)</label>
                                                                            <input type="text" class="form-control"
                                                                                id="contact_person_number"
                                                                                name="contact_person_number"
                                                                                value="{{ $item->contact_person_number }}"
                                                                                required>
                                                        ...
                                                        @else
                                                            <form method="POST"
                                                                action="{{ route('admin.postAddCompany') }}"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="registration_number">MMC Number
                                                                                (*)</label>
                                                                            <input type="text" class="form-control"
                                                                                id="registration_number"
                                                                                name="registration_number"
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if ($errors->has('commission'))
                                                                                <span class="text-danger"
                                                                                    style="font-style: italic;">
                                                                                    <small
                                                                                        style="font-weight: bold">{{ $errors->first('commission') }}</small>
                                                                                </span>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if ($errors->has('contact_person'))
                                                                                <span class="text-danger"
                                                                                    style="font-style: italic;">
                                                                                    <small
                                                                                        style="font-weight: bold">{{ $errors->first('contact_person') }}</small>
                                                                                </span>
                                                                            @endif
                                                                        </div>
                                                                    </div>
