...
<head>
    ...
    <title>Sitara Company Panel Password Reset</title>
...
<body>
    <div class="mainbody">
        <div class="card" bgcolor="#fff">
            ...
            <div class="heading">
                <p>You are receiving this email because we received a password reset request for your Sitara Company Panel account.</p>
